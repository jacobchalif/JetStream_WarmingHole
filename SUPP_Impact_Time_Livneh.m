...
tBerk=readtable('Data/Processed Reanalysis/SfcAir_InOut/Livneh.csv');
dtaRefYear = 1915;
...
ALL_YEARS = 1916:2018; % berkeley length
...
for t = 1:3
    temp = tempAll{t};
    tssn = seasonFunc(tBerk.(['T' temp 'Anom']),@mean,ALL_YEARS(1)+1,ALL_YEARS(end),ALL_YEARS(1));
...
exportgraphics(gcf,'Figures/Supplement/SI3.png','Resolution',450)
